...
public class BubbledTextFlow extends TextFlow {

	//将自定义BubbleLable改为BubbleTextFlow，方便气泡消息插入emoji图片
	...
	*/
	...
	public BubbledTextFlow() {
		super();
		init();
	}

	public BubbledTextFlow(Node... children) {
		super(children);
		init();
	}


	public BubbledTextFlow(BubbleSpec bubbleSpec) {
		super();
		this.bs = bubbleSpec;
		init();
	}

	public BubbledTextFlow(BubbleSpec bubbleSpec, Node... children) {
		super(children);
		this.bs = bubbleSpec;
		init();
	}
